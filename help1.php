...
<html lang="en">
    ...
    <body>
        ...
        <hr>
        <div  id="pages">
            <p>Số trang còn lại của bạn là: <?php if(isset($_SESSION['variable3'])){
        ...
        <button type="submit" id="submit" style="background-color: #E31B4B;"><a href="help.php" style="color: #FFFFFF">Tiếp tục đánh giá</a></button>
